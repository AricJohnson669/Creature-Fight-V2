...
public class Creature extends Actor
{
     ...
     * @param creatureType id the certain type of creature 
     * @return an object of the Creature class
     */
    ...
    /**
     * attack is a method that will get overriden in the subclasses
     * 
     * @param idx is the index choosen by the user
     * @return Nothing is returned
     */
    public void attack(int idx)
    {
        //Attack is an empty method that will get overriden in the subclasses
    }
    ...
    /**
     * getType returns the type of this creature
     * 
     * @param None there are no parameters
     * @return A String that returns the name of the elemental type
     */
