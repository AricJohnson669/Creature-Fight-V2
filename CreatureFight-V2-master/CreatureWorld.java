...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if (turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog (null, "Create A Player Name", "Player One Name Entry", JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog (null, "Create A Player Name", "Player Two Name Entry", JOptionPane.QUESTION_MESSAGE);
            ...
            oneSwitchMenu = new Menu (" Switch", "Golem \n Ivysar", 24, Color.BLACK, Color.WHITE, Color.BLACK, Color.WHITE, new SwitchCommands());
    ...
    /**
     * getTurnNumber returns which player's turn it is in number format.
     * 
     * @param None there are no parameters
     * @return Returns and integer that represents the turn number that tells the player who's turn it is
     */
    ...
    /**
     * setTurnNumber sets which player's turn it is using numbers representing the players.
     * 
     * @param Turn represents the turn number it is changing to
     * @return Nothing is returned
     */
